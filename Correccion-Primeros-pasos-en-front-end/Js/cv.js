...
//empieza en -1 porque no tiene ninguna pintada al iniciarse
...
function efectoHabilidades(){
    ...
    if(distancia_skills>=300 && entro==false){
        ...
        const intervalCoreldraw = setInterval(function(){
            pintarBarra(coreldraw, 16, 4, intervalCoreldraw);
        },100);
        const intervalPhp = setInterval(function(){
            pintarBarra(php, 12, 5, intervalPhp);
        },100);
    }
}
...
function pintarBarra(id_barra, cantidad, indice, interval){
    ...
    if(x < cantidad){
        ...
        elementos[x].style.backgroundColor = "#000000";
    }else{
